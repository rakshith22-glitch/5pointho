                    ...
                    <>
                        ...
                        {user ? (
                            <>
                                {user.userType === 'admin' ? (
                                    <>
                                        <Button color="inherit" component={Link} to="/choose-game-format">Create Round Robin</Button>
                                        <Button color="inherit" component={Link} to="/edit">Edit Events</Button>
                                    </>
                                ) : (
                                    <>
                                        <Button color="inherit" component={Link} to="/become-member">Become Member</Button>
                                    </>
                                )}
                ...
                <Router>
                    <Box>
                        ...
                        <Routes>
                            ...
                            <Route path="/choose-game-format" element={<ChooseGameFormatPage />} />
                            <Route path="/create-round-robin/:format" element={<CreateRoundRobinPage />} />
                            <Route path="/events" element={<RoundRobinList />} />
                            <Route path="/round-robin/:id" element={<RoundRobinDetailsPage />} />
                            <Route path="/edit" element={<AdminEditEvents />} />
                            <Route path="/edit-round-robin/:id" element={<EditRoundRobinPage />} />
